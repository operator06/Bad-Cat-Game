...
def new_menu_function(screen, clock, menu_block, menu_title, menu_block_r, menu_title_r, new_game_button,quit_button,new_game_button_r,quit_button_r):
    running = True
    red_var = 0
    green_blue = 0
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
                if new_game_button_r.collidepoint(mouse_pos):
                    running = False
        ...
        if red_var == 204 and green_blue == 255:
            ...
            if menu_block_r.x == 100:
                screen.blit(new_game_button, (new_game_button_r.x, new_game_button_r.y))
